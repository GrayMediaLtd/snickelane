...
* Investor page
*/
class TestWifiPage extends Page{
	
	private static $singular_name = 'Test Wifi Page';
    private static $plural_name = 'Test Wifi Pages';
    private static $description = 'Test Wifi Landing Page';
...
*/
class TestWifiPage_Controller extends Page_Controller{
